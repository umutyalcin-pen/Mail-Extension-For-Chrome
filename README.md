...
* **Profesyonel Ton:** Resmi yazışmalarınız için e-postalarınızı daha ciddi ve kurumsal bir dile büründürün.
* **Dostça ve Sıcak:** Daha samimi ve kişisel e-postalar için tonu yumuşatın.
* **Kısa ve Öz:** Uzun metinleri, ana mesajı koruyarak daha anlaşılır ve kısa hale getirin.

Bu eklenti, zamandan tasarruf etmenizi sağlarken, e-posta iletişimlerinizin etkisini artırmanıza yardımcı oluyor.

---

### 🚀 Transform Your Email Content with AI: One-Click Editing Power! (EN)

I'm building this Chrome extension to elevate your email content to a new level. With just **one click**, you can use the power of artificial intelligence to edit your emails in 3 different modes:

* **Professional Tone:** Transform your emails into a more serious and corporate style for official correspondence.
* **Friendly & Warm:** Soften the tone for more genuine and personal emails.
* **Concise & Brief:** Shorten long texts while preserving the core message, making them clearer and easier to understand.

This extension helps you save time while enhancing the impact of your email communications.
